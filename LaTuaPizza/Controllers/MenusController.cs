...
namespace LaTuaPizza.Controllers
{
    public class MenusController : Controller
    {
        ...
        public MenusController(_5510Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MenuId,MenuName,MenuDesc,Price")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuId,MenuName,MenuDesc,Price")] Menu menu)
        {
            if (id != menu.MenuId)
            {
                return NotFound();
